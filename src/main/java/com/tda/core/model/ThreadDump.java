...
public final class ThreadDump {
    ...
    private String dumpReason;              // javacore 1TISIGINFO event ("user", OOM, ...); null elsewhere
    ...
    public String dumpReason() { return dumpReason; }
    public void setDumpReason(String r) { dumpReason = r; }
